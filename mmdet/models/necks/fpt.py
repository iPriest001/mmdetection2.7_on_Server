...
class FPT(nn.Module):
    ...
    def __init__(self,
        ...
        if with_norm != 'none':
            ...
            self.fpt_p5 = nn.Conv2d(out_channels * 4, out_channels, 3, padding=1)  # *5 ecause 1+4  , !!!# remove p2 --> *4
            ...
            # self.fpt_p2 = nn.Conv2d(out_channels * 4, out_channels, 3, padding=1)
            # add P6, P7
...
class RenderTrans(nn.Module):
    def __init__(self, channels_high, channels_low, upsample=True, layer_stride=1):
        ...
        self.bn_low = nn.SyncBatchNorm(channels_high)
        ...
        self.bn_high = nn.SyncBatchNorm(channels_high)
        ...
        if upsample:
            ...
            self.bn_upsample = nn.SyncBatchNorm(channels_high)
        else:
            ...
            self.bn_reduction = nn.SyncBatchNorm(channels_high)
